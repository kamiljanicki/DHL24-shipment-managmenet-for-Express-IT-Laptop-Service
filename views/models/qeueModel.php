...
class qeueModel extends model
{
    ...
    public function orderCascade($orderId)
    {
        ...
        if($this -> sendLabelToClient($orderId) === TRUE) return TRUE;
    }
    ...
    public function hiddenRemove($orderId)
    {
        ...
        if($hiddenRemove -> execute()) return TRUE;
    }
    ...
    public function sendLabelToClient($orderId)
    {
        ...
        if(mailerHelper::sendMail( $orderData[0]['client_email'],
            'serwis.expressit@gmail.com',
            'Serwis Laptopów Express IT',
            'serwis.expressit@gmail.com',
            'Serwis laptopów Express IT',
