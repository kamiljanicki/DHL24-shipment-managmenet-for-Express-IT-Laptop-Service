...
<div id = "desktop">
    ...
    <table>
        ...
        <a href="?order_id=<?= $singleOrder[0]['order_id']; ?>" class="w3-bar-item w3-button w3-red">Usuń na zawsze</a>

        <br/>
        <br/>

        <form method="POST" action="?task=trashController&action=moveTo" enctype="multipart/form-data">
            Przenieś:
