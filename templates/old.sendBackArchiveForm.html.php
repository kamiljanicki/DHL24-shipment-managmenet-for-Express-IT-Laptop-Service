...
<div id = "desktop">
    ...
    <form method="POST" action="?task=archiveController&action=sendBackCreateShipment" enctype="multipart/form-data">
    ...
    <table>
        ...
        <input type="submit" name="edit_archive_submit" value="Odeślij"/>
