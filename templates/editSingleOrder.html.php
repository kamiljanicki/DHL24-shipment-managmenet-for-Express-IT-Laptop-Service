...
<div id = "desktop">
    ...
    <form method="POST" action="?task=indexController&action=update" enctype="multipart/form-data">
        ...
        <table>
            ...
            <input type="submit" name="edit_unmoderated_submit" value="Zapisz zmiany"/>
