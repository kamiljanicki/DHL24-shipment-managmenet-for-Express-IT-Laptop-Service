...
$singleOrder = $this -> get('orderCourierConfirmTo');
...
<div id = "desktop">
    ...
    <h2>Wysyłka do:<b> <?= $singleOrder[0]['client_name']; ?> <?= $singleOrder[0]['client_surname']; ?> / <?= $singleOrder[0]['laptop_producer']; ?> <?= $singleOrder[0]['laptop_model']; ?>  / <?= $singleOrder[0]['client_pickup_date']; ?> / <?= $singleOrder[0]['client_pickup_hours']; ?></b></h2>
    ...
    <a href="?task=sendBackController&action=index" class="w3-bar-item w3-button w3-blue">< Wroć do listy zamówionych</a>
    <a href="<?= $singleOrder[0]['label_url']; ?>" class="w3-bar-item w3-button w3-green">Pobierz list przewozowy</a>
