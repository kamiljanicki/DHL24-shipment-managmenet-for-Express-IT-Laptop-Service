...
<div id = "desktop">
    ...
    <table>
        ...
        <a href="?task=qeueController&action=createShipment&order_id=<?= $singleOrder[0]['order_id']; ?>" class="w3-bar-item w3-button w3-green">Realizuj</a>
        <a href="?task=qeueController&action=edit&order_id=<?= $singleOrder[0]['order_id']; ?>" class="w3-bar-item w3-button w3-blue">Edytuj</a>
        <a href="?task=qeueController&action=moveToArchive&order_id=<?= $singleOrder[0]['order_id']; ?>" class="w3-bar-item w3-button w3-brown">Arch.</a>
        <a href="?task=qeueController&action=hiddenRemove&order_id=<?= $singleOrder[0]['order_id']; ?>" class="w3-bar-item w3-button w3-red">Usuń</a>
