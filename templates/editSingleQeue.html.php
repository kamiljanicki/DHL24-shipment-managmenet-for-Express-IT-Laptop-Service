...
<div id = "desktop">
    ...
    <form method="POST" action="?task=qeueController&action=update" enctype="multipart/form-data">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <!-- <input type="text" name="client_pickup_hours" value="<?php //$singleOrder[0]['client_pickup_hours']; ?>" /> -->

                    <select name="client_pickup_hours">
                        <option selected="selected" name="pickup_date" value="<?php echo  $singleOrder[0]['client_pickup_hours']; ?>"><?php echo $singleOrder[0]['client_pickup_hours']; ?></option>
                        ...
                        <option name="pickup_date" value="8-9">8-9</option>
                        <option name="pickup_date" value="9-10">9-10</option>
                        <option name="pickup_date" value="10-11">10-11</option>
                        <option name="pickup_date" value="11-12">11-12</option>
                        <option name="pickup_date" value="12-13">12-13</option>
                        <option name="pickup_date" value="13-14">13-14</option>
                        <option name="pickup_date" value="15-16">15-16</option>
                        <option name="pickup_date" value="16-17">16-17</option>
                        <option name="pickup_date" value="17-18">17-18</option>
                    </select>
        ...
        <input type="submit" name="edit_qeue_submit" value="Zapisz zmiany"/>
